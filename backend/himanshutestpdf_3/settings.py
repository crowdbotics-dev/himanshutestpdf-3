"""
Django settings for himanshutestpdf_3 project.
...
ROOT_URLCONF = 'himanshutestpdf_3.urls'
...
WSGI_APPLICATION = 'himanshutestpdf_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutestpdf_3 API",
    "DESCRIPTION": "API documentation for himanshutestpdf_3 App",
    "VERSION": "v1",
}
